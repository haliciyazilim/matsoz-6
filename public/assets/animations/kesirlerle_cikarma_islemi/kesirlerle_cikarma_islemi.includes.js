...
var Animation = {
    ...
    init:function(container){
        ...
        var rect4 = new Path.SegmentedRectangle(580.5, 10.5, 75, 50, 1, 1, 1, rectFillColor);
        rect4.strokeColor = rectFillColor;
        rect4.opacity = 0;
        var rect5 = new Path.SegmentedRectangle(580.5, 10.5, 25, 50, 1, 1, 1, rectFillColor);
        ...
        var arc = new Path.Arc(new Point(404, 140), new Point(348, 130), new Point(292, 140));
        arc.strokeColor = "black";
        var linee1 = new Path.Line(new Point(292,140), new Point(296,132));
        linee1.strokeColor = "black";
        var linee2 = new Path.Line(new Point(292,140), new Point(302,142));
        ...
        $(Animation.container).append('<div id="frac88"><div id="nom88">3</div><div id="line88"></div><div id="denom88">6</div></div><div id="pls">-</div><div id="frac888"><div id="nom888">2</div><div id="line888"></div><div id="denom888">6</div></div><div id="eqq">=</div><div id="frac8888"><div id="nom8888">1</div><div id="line8888"></div><div id="denom8888">6</div></div>');
        ...
        $(container).append('<div id="frac444"><div id="nom444">1</div><div id="line444"></div><div id="denom444">6</div></div>');
        ...
        $(Animation.container).append('<div id="my4"><p id="myNom4">1</p><div id="myLine4"></div><p id="myDenom4">6</p></div>');
...
var Interaction = {
    ...
    init:function(container){
        ...
        Interaction.questionDiv = Util.dom({parent:Interaction.container, tag:'div', css:questionDivStyle,
            html:'<div id="firstFracDiv" style="position:absolute;top:1px;left:0px;width:65px;height:60px;"></div>' +
                '<span id="intPlus" style="position:absolute;top:16px;left:75px;">-</span>' +
                '</div><div id="secondFracDiv" style="position:absolute;top:1px;left:96px;width:65px;height:60px;"></div>' +
...
var RationalNumber = Class.extend({
    ...
    toHTML:function(fontSize){
        ...
        var height = (2*line)+1;
        var width = height+6;
        var width2 = Math.round(width * 0.6);

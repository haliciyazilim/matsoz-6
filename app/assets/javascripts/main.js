...
Main.initializeToolbar = function(){
    ...
    Main.InfoDialog.addContent(
        'Program Hakkında',
        '<div style="width: 100%; margin: auto; box-sizing: border-box; padding: 100px; padding-top: 50px; padding-right: 250px; line-height: 20px;">Tüm Hakları Saklıdır (C) 2012 - Halıcı Bilgi İşlem AŞ<br/><a href="http://www.halici.com.tr" target="_blank">www.halici.com.tr</a><br/>Etkileşimli Matematik Sözlüğü<br/>Güncelleme Tarihi:  2012-11-08<br/>Versiyon: 1.0.1<br/><br/>Tablet için kullanıma uygun olup Chrome ve Safari tarayıcıları ile çalışır.<br/>Tarayıcı Gereksinimleri: Javascript, HTML5, CSS3<br/>İhtiyaç duyulacak gereksinimler ve programın işlevselliği kullandığınız işletim sistemi ve donanıma bağlı olarak değişiklik gösterebilir.<br/></div>'
    );
    Main.InfoDialog.addContent(
        'Kullanım Şartları',
    ...
    Main.InfoDialog.addContent('Kullanici Kilavuzu','<iframe src="/resources/matsoz_manuel/matsoz_manuel.htm" style="width: 100%; height: 99%; border: none; padding: 0px; box-sizing: border-box; overflow: hidden; margin: 0px;"></iframe>');

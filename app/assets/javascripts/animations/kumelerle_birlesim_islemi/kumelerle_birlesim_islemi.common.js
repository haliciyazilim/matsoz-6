var sorgular=function(){
    ...
    switch(this.sorguSecici){
        case 1:
            this.kume=new Set({type:Set.SMALLER_THAN, value:6});
            this.kume;
            break;
        case 2:
            this.kume=new Set({type:Set.GREATER_THAN_DIGIT_EVEN, value:0});
            this.kume;
            break;
        case 3:
            this.kume=new Set({type:Set.DIGIT, value:10});
            this.kume;
            break;
        case 4:
            this.kume=new Set({type:Set.SMALLER_THAN_PRIME, value:10});
            this.kume;
            break;
    }
    ...
    this.yeniSoru=function(isim){
        ...
        this.isim=isim;
        //this.soru=sorgular();
        if(this.soruCesidi==2)
            return this.kume.getDefinitionString(isim);
        else
            return this.kume.getElementsString(isim);
    }

var Animation = {
	...
	init:function(container){
        ...
        Animation.dot1 = new Path.Circle(new Point(237,80),6);
        Animation.dot1.strokeColor = "black";
        Animation.dot1.fillColor = "black";
        Animation.dot1.opacity = 0;

        Animation.dot2 = new Path.Circle(new Point(525,80),6);
        ...
        animHelper.animate({
            ...
            update:function(){
                ...
                Animation.line = new Path.Line(new Point(237.5,80.5), new Point(237.5+this.X,80.5));

...
var Interaction = {
	...
	*/
	...
	onFail : function(){
            if(Interaction.soruSayaci%2==0){
                Interaction.setStatus("Yanlış cevap, doğru cevap yukarıda  <b style='color:green'>yeşil</b> renkle gösterilmiştir.", false);
                ...
                Interaction.setStatus("Yanlış cevap, doğru cevap: <b style='color:green'>"+Interaction.randomNumber+"</b>", false);
                $("#girdi").css("color","red");
            }
